  ...
  return (
    <form onSubmit={submit} className="space-y-5" noValidate>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <FormField id="tenant-slug" label={t('forms.slug')} error={errors.slug && t(errors.slug.message!)} placeholder="empresa-exemplo" autoCapitalize="none" {...register('slug')} />
      ...
      <div className="border-t pt-5">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <FormField id="admin-password" label={t('common.password')} type="password" autoComplete="new-password" error={errors.adminPassword && t(errors.adminPassword.message!)} {...register('adminPassword')} />
            <p className="mt-2 text-xs leading-5 text-muted-foreground">{t('forms.passwordHint')}</p>
          </div>
        </div>
      </div>
